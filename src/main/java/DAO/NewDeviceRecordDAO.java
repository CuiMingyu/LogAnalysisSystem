...
public class NewDeviceRecordDAO {
    ...
    public void addNewStyle(Date date,String style,int number){
    ...
    public int getdeviceid(NewDeviceRecord ndr){
        Statement st=null;
        ResultSet rs=null;
        int num=0;
        try{
    ...
    public List<NewDeviceRecord> SelectByDate(Date date1,Date date2){
        PreparedStatement ps=null;
        ResultSet rs=null;
    ...
    public List<NewDeviceRecord> SelectByDateAndMachine(Date date1,Date date2,String machinename){
        PreparedStatement ps=null;
        ResultSet rs=null;
        List<NewDeviceRecord> ndrList=new ArrayList<>();
        try{
    ...
    public List<NewDeviceRecord> SelectByDateAndStyle(Date date1,Date date2,String stylename){
        PreparedStatement ps=null;
        ResultSet rs=null;
        List<NewDeviceRecord> ndrList=new ArrayList<>();
        try{
